...
1. Entity is a class encapsulating data and you can read more what is an entity in the [model architecture article](../model/introduction-to-model-architecture.md).
